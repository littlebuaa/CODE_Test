...
#		return dut
	...
	def sendCmd(self, cmd, timeout_ms):
		...
		logger.info("Total execution time is %d ms!" %(time() - time_start)*1000)
...
class Co2Jig:
	...
	__dilution_threshold = 1700 # threshold for decide using N2 or fresh air
